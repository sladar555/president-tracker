const Spinner = ({visible}: any) => {
    return (
        <>
            {
                visible? 
                    <div role="status" className="absolute justify-items-center items-center -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2 bg-transparent z-50 bg-opacity-50 w-full h-full">
